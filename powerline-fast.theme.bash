...
USER_INFO_THEME_PROMPT_TEXT_COLOR=14
USER_INFO_THEME_PROMPT_COLOR=25
...
SCM_THEME_PROMPT_CLEAN_COLOR=22
...
HOST_THEME_PROMPT_COLOR=16

POWERLINE_PROMPT=${POWERLINE_PROMPT:="hostname user_info python_venv ruby wd scm"}
